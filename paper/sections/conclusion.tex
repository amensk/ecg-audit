...
We present the first systematic calibration audit of ECG foundation models, executing a
5-model $\times$ 4-dataset benchmark totalling 20 evaluation cells across 12{,}877 ECG
records (2{,}000 PTB-XL; 6{,}877 CPSC2018; 2{,}000 CODE-15\%; 2{,}000 MIMIC-IV-ECG)
under patient-level leakage-controlled splits.
...
structure---multi-label vs.\ single-label---is the mediating factor. Third, \textbf{post-hoc
